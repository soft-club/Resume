...
export const Header = () => {
  ...
  const accentColor = t`from-indigo-600 to-violet-600`;
        ...
        <div className="container flex h-20 items-center justify-between py-3">
          <Link to="/" className="flex items-center gap-2">
            <div className="relative">
              <div
                className={`absolute -inset-1 rounded-full bg-gradient-to-r ${accentColor} opacity-70 blur-sm`}
              ></div>
              <div className="relative">
                <Logo size={36} />
              </div>
            ...
            <div className="hidden flex-col md:flex">
              ...
              <span className="text-xs text-foreground/50">cvport.uz</span>
            </div>
          </Link>
          ...
          {/* Переключатель языка и темы для десктопа */}
          <div className="mr-4 hidden items-center gap-2 md:flex">
            <div className="mr-1 border-r border-border/10 pr-2">
              <LocaleSwitch />
            </div>
            <ThemeSwitch />
          </div>
          ...
          {/* Переключатель языка и темы для мобильных */}
